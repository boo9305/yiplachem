          ...
          <div className={sty.vietnamMain}>
            ...
            <div className={sty.vietnamTxt}>
              <div className={sty.vietnamTxtInner}>
                <p>
                  <span className={sty.emBar}>Date of establishment</span>
                </p>
                <p>
                  <span className={sty.emBar}>Adress</span>
                </p>
                <p>
                  <span className={sty.emBar}>Number of employees</span>
                </p>
                <p>
                  <span className={sty.emBar}>Main Products</span>
                </p>
                <p>
                  <span className={sty.emBar}>Major Customers</span>
